...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-dark">Pages/</span> All Products</h4>
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr>
            ...
            <td>
              ...
              <br>
              <a href="{{ route('editproductimg', $product->id) }}" class="btn btn-primary">Update Img</a>
            </td>
